...
SOURCES = [
    ...
    dict(name="RAND", bias="Industria militar / gubernamental EEUU", tier="diario", group="secundaria",
    ...
    dict(name="CSIS", bias="Atlantista/industria de defensa", tier="diario", group="secundaria",
    ...
    dict(name="Carnegie Endowment", bias="Atlantista (liberal-internacionalista)", tier="diario", group="secundaria",
    ...
    dict(name="Foreign Affairs", bias="Atlantista (establishment)", tier="diario", group="secundaria",
    ...
    dict(name="HCSS", bias="Gubernamental — Países Bajos", tier="diario", group="secundaria",
         rss="https://hcss.nl/feed/", scrape_url="https://hcss.nl/publications/", scrape_selector="a",
         search_query="site:hcss.nl"),
    dict(name="Bruegel", bias="Atlantista/UE (economía)", tier="diario", group="secundaria",
         rss="https://www.bruegel.org/rss.xml", scrape_url="https://www.bruegel.org/latest",
         scrape_selector="a", search_query="site:bruegel.org"),
    dict(name="Valdai Club", bias="Estatal ruso (semi-oficial)", tier="diario", group="secundaria",
    ...
    dict(name="RIAC", bias="Estatal ruso (semi-oficial)", tier="diario", group="secundaria",
    ...
    dict(name="Bulletin of Atomic Scientists", bias="Académico/independiente (nuclear)", tier="diario", group="secundaria",
    ...
    dict(name="CSET Georgetown", bias="Gubernamental/académico — EEUU (IA)", tier="diario", group="secundaria",
    ...
    dict(name="SWP Berlin", bias="Gubernamental — Alemania", tier="diario", group="secundaria",
    ...
    dict(name="IFRI", bias="Gubernamental/académico — Francia", tier="diario", group="secundaria",
         rss=None, scrape_url="https://www.ifri.org/en/publications", scrape_selector="a",
         search_query="site:ifri.org"),
    dict(name="MP-IDSA", bias="Gubernamental — India", tier="diario", group="secundaria",
    ...
    dict(name="International Crisis Group", bias="Académico/independiente (referencia en prevención de conflictos)",
         tier="diario", group="analisis",
    ...
    dict(name="Brookings Institution", bias="Atlantista (establishment, centrista)", tier="diario", group="analisis",
    ...
    dict(name="Council on Foreign Relations (CFR)", bias="Atlantista (establishment)", tier="diario", group="analisis",
         rss="https://www.cfr.org/rss.xml", scrape_url="https://www.cfr.org/blogs",
         scrape_selector="a", search_query="site:cfr.org"),
    dict(name="Belfer Center (Harvard Kennedy School)", bias="Académico — EEUU", tier="diario", group="analisis",
    ...
    dict(name="Lowy Institute", bias="Atlantista — Australia/Asia-Pacífico", tier="diario", group="analisis",
    ...
    dict(name="IISS (International Institute for Strategic Studies)",
         bias="Atlantista (Reino Unido, referencia en balance militar)", tier="diario", group="analisis",
    ...
    dict(name="Center for China and Globalization (CCG)",
         bias="Gubernamental/estatal chino (semi-oficial, independencia disputada)", tier="diario", group="analisis",
         rss="https://www.ccg.org.cn/?feed=rss2", scrape_url="https://www.ccg.org.cn/",
         scrape_selector="a", search_query="site:ccg.org.cn"),
    dict(name="Observer Research Foundation (ORF)", bias="Gubernamental/académico — India", tier="diario", group="analisis",
         rss="https://www.orfonline.org/feed", scrape_url="https://www.orfonline.org/research",
         scrape_selector="a", search_query="site:orfonline.org"),
    dict(name="Institute for Security Studies (ISS Africa)",
         bias="Académico/independiente — África (Sudáfrica)", tier="diario", group="analisis",
